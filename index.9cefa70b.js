...
var $18f47696fbaeb298$exports = {};

(parcelRequire("aKzDW")).register(new URL("", import.meta.url).toString(), JSON.parse('["apKlN","index.9cefa70b.js","irRAI","map-zones.3fa9c234.js","dxGrs","map-1939.7fbdf677.js","3VtzB","map-2024.9547b2a9.js","1llQ5","map-1806.fa0de760.js","32lWK","map-1444.6c6faf14.js","gPO8F","map-1619.00cd0e76.js"]'));
...
const $56a0b18e519895ee$var$handlePresetChange = async (event)=>{
    ...
    if (event.target.value === "2") data = await (parcelRequire("c8sox"));
...
//# sourceMappingURL=index.9cefa70b.js.map
