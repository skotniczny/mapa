...
parcelRegister("4cUJO", function(module, exports) {

var $92x9i = parcelRequire("92x9i");
module.exports = $92x9i("gLpsD").then(()=>parcelRequire("hAGee"));

});

var $3033480c74381387$exports = {};

(parcelRequire("aKzDW")).register(new URL("", import.meta.url).toString(), JSON.parse('["apKlN","index.6eedcc5b.js","irRAI","map-zones.3fa9c234.js","dxGrs","map-1939.7fbdf677.js","3VtzB","map-2024.9547b2a9.js","1llQ5","map-1806.fa0de760.js","32lWK","map-1444.a504bdbb.js","gLpsD","map-germany.e853a786.js"]'));
...
const $56a0b18e519895ee$var$handlePresetChange = async (event)=>{
    ...
    if (event.target.value === "1") data = await (parcelRequire("9x3ob"));
    if (event.target.value === "2") data = await (parcelRequire("4cUJO"));
    if (event.target.value === "3") data = await (parcelRequire("clwAu"));
    if (event.target.value === "4") data = await (parcelRequire("cxRfR"));
    if (event.target.value === "5") data = await (parcelRequire("b9l05"));
...
//# sourceMappingURL=index.6eedcc5b.js.map
