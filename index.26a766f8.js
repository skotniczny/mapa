...
const $56a0b18e519895ee$var$resetMap = ()=>{
    for (const item of $56a0b18e519895ee$var$mapState.keys)try {
...
const $56a0b18e519895ee$var$readState = ()=>{
    ...
    for (const item of $56a0b18e519895ee$var$mapState.keys)try {
        const el = document.querySelector(`#${item}`);
        if (el) el.style.fill = $56a0b18e519895ee$var$mapState.get(item);
    } catch (e) {
        console.error("B\u0142\u0105d:", e.message);
    }
};
...
//# sourceMappingURL=index.26a766f8.js.map
