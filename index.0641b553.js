...
const handlePresetChange = async (event)=>{
    ...
    if (event.target.value === "1") data = await require("31c3a541fea6e160");
    if (event.target.value === "2") data = await require("60fd1a25a8c1c97d");
    if (event.target.value === "3") data = await require("32eb586669ed79bb");
...
},{"./js/svg-utils.js":"d6Y5V","./js/utils.js":"72Dku","./js/modal.js":"aHHgN","./js/data.js":"kq51T","./js/map-state.js":"7104t","4c86155dcc4d77fb":"6lt9x","60fd1a25a8c1c97d":"iQfEv","32eb586669ed79bb":"dOcfe","31c3a541fea6e160":"hdCkB"}],"d6Y5V":[function(require,module,exports) {
/*
...
},{}],"iQfEv":[function(require,module,exports) {
...
},{"747da6e6b124f76f":"61B45","ea7421cf8fa5fbac":"lgJ39"}],"hdCkB":[function(require,module,exports) {
...
},{"3e8043d723121212":"61B45","2193b5a5dff78496":"lgJ39"}]},["gbXMy","bNKaB"], "bNKaB", "parcelRequire4556")
