...
var _modalSearchJs = require("./js/modal-search.js");
var _modalSearchJsDefault = parcelHelpers.interopDefault(_modalSearchJs);
var _svgMapJs = require("./js/svg-map.js");
var _svgMapJsDefault = parcelHelpers.interopDefault(_svgMapJs);
const btnsMenu = document.querySelector(".menu-v");
const filePicker = document.querySelector("#filePicker");
const presets = document.querySelector("#presets");
(0, _svgMapJsDefault.default).init({
    el: document.querySelector("svg"),
    elToolsMenu: document.querySelector(".menu-tools"),
    localStorageKey: "mapState"
});
(0, _modalSearchJsDefault.default).create(document.querySelector(".modal"));
const handleKeyboard = (event)=>{
    if (event.target.tagName.toLowerCase() !== "input") {
        const key = event.key.toLowerCase();
        if (key === "arrowright" || key === "d") (0, _svgMapJsDefault.default).moveMap("right");
        if (key === "arrowleft" || key === "a") (0, _svgMapJsDefault.default).moveMap("left");
        if (key === "arrowup" || key === "w") (0, _svgMapJsDefault.default).moveMap("up");
        if (key === "arrowdown" || key === "s") (0, _svgMapJsDefault.default).moveMap("down");
        if (key === "z" && event.ctrlKey) (0, _svgMapJsDefault.default).undoRecent();
    }
};
const handlePresetChange = async (event)=>{
    let data = [];
    if (event.target.value === "") return;
    if (event.target.value === "0") data = await require("4c86155dcc4d77fb");
    if (event.target.value === "1") data = await require("100cffce4b66aa62");
    if (event.target.value === "2") data = await require("c49183b8585b8d07");
    if (event.target.value === "3") data = await require("218ae72d6d112e71");
    if (event.target.value === "4") data = await require("31c3a541fea6e160");
    if (event.target.value === "5") data = await require("2fcf078019a0db29");
    if (event.target.value === "6") data = await require("60fd1a25a8c1c97d");
    if (event.target.value === "7") data = await require("32eb586669ed79bb");
    document.activeElement.blur();
    (0, _svgMapJsDefault.default).setMap(data);
};
...
btnsMenu.addEventListener("click", (event)=>{
    ...
    if (targetId === "menuBtn") (0, _modalSearchJsDefault.default).open();
    if (targetId === "downloadBtn") (0, _svgMapJsDefault.default).saveToSvgFile();
    if (targetId === "resetBtn") {
        (0, _svgMapJsDefault.default).resetMap();
        presets.value = "";
    }
    if (targetId === "colorBtn") (0, _svgMapJsDefault.default).colorMap();
    if (targetId === "saveBtn") (0, _svgMapJsDefault.default).saveToJsonFile();
});

},{"./js/modal-search.js":"1v7Ey","./js/svg-map.js":"8iAdS","4c86155dcc4d77fb":"6lt9x","100cffce4b66aa62":"aR8Mk","c49183b8585b8d07":"jG2Up","218ae72d6d112e71":"1wznD","31c3a541fea6e160":"hdCkB","2fcf078019a0db29":"eBDQH","60fd1a25a8c1c97d":"iQfEv","32eb586669ed79bb":"dOcfe","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1v7Ey":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
const create = (el)=>{
    modal = el;
    (0, _modalJs.createModalWithSearch)(el, modalContent, handleSearch);
    modal.addEventListener("click", pickFlag);
};
const open = ()=>{
    (0, _modalJs.openModal)(modal);
};
const modalSearch = {
    create,
    open
...
},{"./modal.js":"aHHgN","./data.js":"kq51T","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"aHHgN":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"8iAdS":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _svgUtilsJs = require("./svg-utils.js");
var _utilsJs = require("./utils.js");
var _mapStateJs = require("./map-state.js");
const app = {
    map: null,
    canvas: null,
    colorPicker: null,
...
const handleMouseWheel = (event)=>{
    ...
    (0, _svgUtilsJs.svgScale)(app.canvas, fixedPoint, config.scale, nextScale);
...
const handleMapClick = (event)=>{
    ...
    if (tools.colorPickMode.checked && target.tagName === "path") {
        tools.colorPicker.value = (0, _utilsJs.rgb2hex)(target.style.fill);
        tools.colorPickMode.click();
    } else if (target.style.fill && (0, _utilsJs.rgb2hex)(target.style.fill) === color) {
        target.style.fill = "";
        app.mapState.remove([
            target.id
        ]);
...
const handleMapMousedown = (event)=>{
    if (event.button !== 0) return;
    const position = (0, _svgUtilsJs.svgPositionGet)(app.canvas);
    ...
    handleMapDrag = (()=>{
        return (e)=>{
            ...
            (0, _svgUtilsJs.svgPositionSet)(app.canvas, {
                x,
                y
            });
        };
...
const readState = ()=>{
    app.mapState.load();
    (0, _utilsJs.fillElements)(app.mapState);
};
...
const init = (conf)=>{
    ...
    app.mapState = new (0, _mapStateJs.MapState)(conf.localStorageKey);
...
const saveToSvgFile = ()=>{
    /* global XMLSerializer */ const source = new XMLSerializer().serializeToString(app.map);
...
const saveToJsonFile = ()=>{
    const content = [];
    for (const item of app.mapState.keys)content.push({
        pathId: item,
        color: app.mapState.get(item)
    });
    const a = document.createElement("a");
    const file = new Blob([
...
const resetMap = ()=>{
    (0, _utilsJs.clearElements)(app.mapState);
    app.mapState.reset();
    app.mapState.save();
};
const colorMap = ()=>{
    const colors = config.palette;
    const groups = Array.from(app.canvas.children).filter((element)=>element.tagName === "g").map((element)=>element.querySelectorAll("path"));
...
const moveMap = (direction)=>{
    const position = (0, _svgUtilsJs.svgPositionGet)(app.canvas);
    if (direction === "right") (0, _svgUtilsJs.svgPositionSet)(app.canvas, {
        x: position.x - 50,
        y: position.y
    });
    if (direction === "left") (0, _svgUtilsJs.svgPositionSet)(app.canvas, {
        x: position.x + 50,
        y: position.y
    });
    if (direction === "up") (0, _svgUtilsJs.svgPositionSet)(app.canvas, {
        x: position.x,
        y: position.y + 50
    });
    if (direction === "down") (0, _svgUtilsJs.svgPositionSet)(app.canvas, {
        x: position.x,
        y: position.y - 50
    });
};
...
},{"./svg-utils.js":"d6Y5V","./utils.js":"72Dku","./map-state.js":"7104t","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"d6Y5V":[function(require,module,exports) {
/*
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"6lt9x":[function(require,module,exports) {
module.exports = require("5397b80a6a6256be")(require("637e3422f573234d").getBundleURL("lPpKD") + "map-zones.9281b3c2.js" + "?" + Date.now()).catch((err)=>{
    delete module.bundle.cache[module.id];
    throw err;
}).then(()=>module.bundle.root("bOZ9O"));

},{"5397b80a6a6256be":"61B45","637e3422f573234d":"lgJ39"}],"61B45":[function(require,module,exports) {
"use strict";
...
},{}],"aR8Mk":[function(require,module,exports) {
module.exports = require("6c4dc63a1f4af1b")(require("a6d4e1beb14bdb90").getBundleURL("lPpKD") + "map-spqr.f5e3930a.js" + "?" + Date.now()).catch((err)=>{
    delete module.bundle.cache[module.id];
    throw err;
}).then(()=>module.bundle.root("k9tlY"));

},{"6c4dc63a1f4af1b":"61B45","a6d4e1beb14bdb90":"lgJ39"}],"jG2Up":[function(require,module,exports) {
module.exports = require("86d78b73366d0e6a")(require("c9b6e999c3dc2c07").getBundleURL("lPpKD") + "map-1444.ffa5bb0a.js" + "?" + Date.now()).catch((err)=>{
    delete module.bundle.cache[module.id];
    throw err;
}).then(()=>module.bundle.root("8tEih"));

},{"86d78b73366d0e6a":"61B45","c9b6e999c3dc2c07":"lgJ39"}],"1wznD":[function(require,module,exports) {
module.exports = require("1b890d1d4dab4477")(require("f6f9c40e4b57a9a0").getBundleURL("lPpKD") + "map-1619.a7046a25.js" + "?" + Date.now()).catch((err)=>{
    delete module.bundle.cache[module.id];
    throw err;
}).then(()=>module.bundle.root("1QHka"));

},{"1b890d1d4dab4477":"61B45","f6f9c40e4b57a9a0":"lgJ39"}],"hdCkB":[function(require,module,exports) {
module.exports = require("3e8043d723121212")(require("2193b5a5dff78496").getBundleURL("lPpKD") + "map-1806.c3742f20.js" + "?" + Date.now()).catch((err)=>{
    delete module.bundle.cache[module.id];
    throw err;
}).then(()=>module.bundle.root("i4znO"));

},{"3e8043d723121212":"61B45","2193b5a5dff78496":"lgJ39"}],"eBDQH":[function(require,module,exports) {
module.exports = require("92eb24134da6be9")(require("a108b0ad5c32b3d6").getBundleURL("lPpKD") + "map-1912.584c9f0a.js" + "?" + Date.now()).catch((err)=>{
    delete module.bundle.cache[module.id];
    throw err;
}).then(()=>module.bundle.root("8Y70S"));

},{"92eb24134da6be9":"61B45","a108b0ad5c32b3d6":"lgJ39"}],"iQfEv":[function(require,module,exports) {
module.exports = require("8041436358e17720")(require("82a2e436134f5a44").getBundleURL("lPpKD") + "map-1939.414f8113.js" + "?" + Date.now()).catch((err)=>{
    delete module.bundle.cache[module.id];
    throw err;
}).then(()=>module.bundle.root("kc9M8"));

},{"8041436358e17720":"61B45","82a2e436134f5a44":"lgJ39"}],"dOcfe":[function(require,module,exports) {
module.exports = require("747da6e6b124f76f")(require("ea7421cf8fa5fbac").getBundleURL("lPpKD") + "map-2024.5219db4e.js" + "?" + Date.now()).catch((err)=>{
    delete module.bundle.cache[module.id];
    throw err;
}).then(()=>module.bundle.root("leNoF"));

},{"747da6e6b124f76f":"61B45","ea7421cf8fa5fbac":"lgJ39"}]},["gbXMy","bNKaB"], "bNKaB", "parcelRequire4556")
