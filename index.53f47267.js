...
var $4c7f5549ecb11571$exports = {};

(parcelRequire("aKzDW")).register(new URL("", import.meta.url).toString(), JSON.parse('["apKlN","index.53f47267.js","irRAI","map-zones.3fa9c234.js","dxGrs","map-1939.7fbdf677.js","3VtzB","map-2024.9547b2a9.js"]'));
...
const $56a0b18e519895ee$var$handlePresetChange = async (event)=>{
    ...
    if (event.target.value === "1") data = await (parcelRequire("cxRfR"));
    if (event.target.value === "2") data = await (parcelRequire("b9l05"));
...
//# sourceMappingURL=index.53f47267.js.map
