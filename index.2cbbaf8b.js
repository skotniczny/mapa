...
const $23483fd903922e0d$var$init = (conf)=>{
    ...
    $23483fd903922e0d$var$tools.menu.addEventListener("click", (event)=>{
        ...
        if (targetId === "colorpicker") $23483fd903922e0d$var$tools.colorPickMode.click();
    });
...
const $23483fd903922e0d$var$moveMap = (direction)=>{
    const position = (0, $696041bd1b84be8f$export$31d524b4cdd8591b)($23483fd903922e0d$var$app.canvas);
    if (direction === "right") (0, $696041bd1b84be8f$export$5506cdffa4707d37)($23483fd903922e0d$var$app.canvas, {
        x: position.x - 50,
        y: position.y
    });
    if (direction === "left") (0, $696041bd1b84be8f$export$5506cdffa4707d37)($23483fd903922e0d$var$app.canvas, {
        x: position.x + 50,
        y: position.y
    });
    if (direction === "up") (0, $696041bd1b84be8f$export$5506cdffa4707d37)($23483fd903922e0d$var$app.canvas, {
        x: position.x,
        y: position.y + 50
    });
    if (direction === "down") (0, $696041bd1b84be8f$export$5506cdffa4707d37)($23483fd903922e0d$var$app.canvas, {
        x: position.x,
        y: position.y - 50
    });
};
...
(0, $c94cd653c1ae6b76$export$2e2bcd8739ae039).create($56a0b18e519895ee$var$modal);
...
//# sourceMappingURL=index.2cbbaf8b.js.map
