...
parcelRegister("97TFW", function(module, exports) {

var $92x9i = parcelRequire("92x9i");
module.exports = $92x9i("26qLl").then(()=>parcelRequire("578HV"));
...
var $5e4ccc975266659e$exports = {};

(parcelRequire("aKzDW")).register(new URL("", import.meta.url).toString(), JSON.parse('["apKlN","index.d40f7fbe.js","irRAI","map-zones.3fa9c234.js","89ZJL","map-spqr.9a3a4317.js","32lWK","map-1444.6c6faf14.js","gPO8F","map-1619.00cd0e76.js","1llQ5","map-1806.fa0de760.js","26qLl","map-1912.8ca64376.js","dxGrs","map-1939.08f43cc3.js","3VtzB","map-2024.9547b2a9.js"]'));
...
const $56a0b18e519895ee$var$colorPickMode = document.querySelector("#colorpickerMode");
const $56a0b18e519895ee$var$btnsMenu = document.querySelector(".menu-v");
const $56a0b18e519895ee$var$toolsMenu = document.querySelector(".menu-tools");
...
const $56a0b18e519895ee$var$handleMapClick = (event)=>{
    ...
    if ($56a0b18e519895ee$var$colorPickMode.checked && target.tagName === "path") {
        $56a0b18e519895ee$var$colorPicker.value = (0, $7b5873fbd7a9e904$export$883528fb0afa7177)(target.style.fill);
        $56a0b18e519895ee$var$colorPickMode.click();
...
let $56a0b18e519895ee$var$handleMapDrag;
const $56a0b18e519895ee$var$endMove = (event, cursor)=>{
    if (event.button !== 0) return;
    window.removeEventListener("mousemove", $56a0b18e519895ee$var$handleMapDrag);
    window.removeEventListener("mouseup", $56a0b18e519895ee$var$endMove);
    $56a0b18e519895ee$var$canvas.style.pointerEvents = "";
    $56a0b18e519895ee$var$map.style.cursor = cursor;
};
const $56a0b18e519895ee$var$handleMapMousedown = (event)=>{
    if (event.button !== 0) return;
    const position = (0, $696041bd1b84be8f$export$31d524b4cdd8591b)($56a0b18e519895ee$var$canvas);
    const currentCursor = $56a0b18e519895ee$var$map.style.cursor;
    $56a0b18e519895ee$var$handleMapDrag = (()=>{
        return (e)=>{
            $56a0b18e519895ee$var$canvas.style.pointerEvents = "none";
            $56a0b18e519895ee$var$map.style.cursor = "move";
            const x = position.x + (e.clientX - event.x);
            const y = position.y + (e.clientY - event.y);
            (0, $696041bd1b84be8f$export$5506cdffa4707d37)($56a0b18e519895ee$var$canvas, {
                x: x,
                y: y
            });
        };
    })();
    window.addEventListener("mousemove", $56a0b18e519895ee$var$handleMapDrag);
    window.addEventListener("mouseup", (event)=>$56a0b18e519895ee$var$endMove(event, currentCursor));
};
const $56a0b18e519895ee$var$handleMapContextmenu = (event)=>{
    event.preventDefault();
    const target = event.target;
    if ($56a0b18e519895ee$var$isInvalidElement(target) || $56a0b18e519895ee$var$colorPickMode.checked) return;
...
const $56a0b18e519895ee$var$saveToJsonFile = ()=>{
    const content = [];
    for (const item of $56a0b18e519895ee$var$mapState.keys)content.push({
        pathId: item,
        color: $56a0b18e519895ee$var$mapState.get(item)
    });
...
const $56a0b18e519895ee$var$handlePresetChange = async (event)=>{
    ...
    if (event.target.value === "5") data = await (parcelRequire("97TFW"));
    if (event.target.value === "6") data = await (parcelRequire("cxRfR"));
    if (event.target.value === "7") data = await (parcelRequire("b9l05"));
    document.activeElement.blur();
    $56a0b18e519895ee$var$resetMap();
    $56a0b18e519895ee$var$mapState.set(data);
    (0, $7b5873fbd7a9e904$export$66eec673fb17698c)($56a0b18e519895ee$var$mapState);
    $56a0b18e519895ee$var$mapState.save();
};
const $56a0b18e519895ee$var$handleColorPickModeChange = ()=>{
    $56a0b18e519895ee$var$map.style.cursor = $56a0b18e519895ee$var$colorPickMode.checked ? "crosshair" : "auto";
};
$56a0b18e519895ee$var$handleColorPickModeChange();
...
$56a0b18e519895ee$var$map.addEventListener("mousedown", $56a0b18e519895ee$var$handleMapMousedown);
...
$56a0b18e519895ee$var$colorPickMode.addEventListener("change", $56a0b18e519895ee$var$handleColorPickModeChange);
$56a0b18e519895ee$var$btnsMenu.addEventListener("click", (event)=>{
    ...
    if (targetId === "saveBtn") $56a0b18e519895ee$var$saveToJsonFile();
});
$56a0b18e519895ee$var$toolsMenu.addEventListener("click", (event)=>{
    const targetId = event.target.id;
    if (targetId === "colorpicker") $56a0b18e519895ee$var$colorPickMode.click();
});


//# sourceMappingURL=index.d40f7fbe.js.map
